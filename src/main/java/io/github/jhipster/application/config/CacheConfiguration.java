...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(io.github.jhipster.application.domain.Employee.class.getName() + ".attendances", jcacheConfiguration);
            cm.createCache(io.github.jhipster.application.domain.Attendance.class.getName(), jcacheConfiguration);
