...
public class LearningjhipsterApp {

    private static final Logger log = LoggerFactory.getLogger(LearningjhipsterApp.class);

    private final Environment env;

    public LearningjhipsterApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes learningjhipster.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(LearningjhipsterApp.class);
